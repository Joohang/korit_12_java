...
public class PersonMain {
    public static void main(String[] args) {
        ...
        // getter 를 적용하여 field를 조회하는 방법
        System.out.println(person1.getName());
        System.out.println(person1.getAge());
        System.out.println(person1.getAddress());

        // 여기서 getter만을 사용하여
        // 김일일 학생의 나이는 0 살이고 주소는 서울특별시 종로구. 라고 룩력하도록 작성하시오.
        System.out.print(person1.getName());
        System.out.print(" 학생의 나이는 ");
        System.out.print(person1.getAge());
        System.out.print(" 살이고, 주소는");
        System.out.print(person1.getAddress());
        System.out.println(".");
        ...
        // channing method를 잘 적용하려면 특정 메서드의 결과값이 어떻게 되는가를 아는 것이 매우 중요합니다.
